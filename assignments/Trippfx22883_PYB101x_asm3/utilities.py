...
def fetch_fines(url='https://firebasestorage.googleapis.com/v0/b/funix-way.appspot.com/o/xSeries%2FChung%20chi%20dieu%20kien%2FPYB101x_1.1%2FASM_Resources%2Flate_coming.json?alt=media&token=55246ee9-44fa-4642-aca2-dde101d705de'):
...
def compute_fine(late_comming_days, url='https://firebasestorage.googleapis.com/v0/b/funix-way.appspot.com/o/xSeries%2FChung%20chi%20dieu%20kien%2FPYB101x_1.1%2FASM_Resources%2Flate_coming.json?alt=media&token=55246ee9-44fa-4642-aca2-dde101d705de'):
    ...
    for d in fines:
        ...
        if min <= late_comming_days < max:
            ...
            return fine
# # todo: Loop to many times???
# def compute_fine(fines, late_comming_days):
#     for d in fines:
#         min = d.get('min', 0)
#         max = d.get('max', sys.maxsize)
#         # max = d.get('max', 31)
...
def main():
    ...
    #     tax = compute_tax(tax_rates, amount)
